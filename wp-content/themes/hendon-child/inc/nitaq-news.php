	...
	function hendon_child_nitaq_news_details_meta_box( $post ) {
		...
		<div class="nitaq-news-admin-fields" dir="rtl">
			...
			<p>
				...
				<input id="nitaq_news_button_link" name="nitaq_news_button_link" type="url" value="<?php echo esc_url( $link ); ?>" placeholder="<?php echo esc_url( home_url( '/chelsea/' ) ); ?>" style="width:100%;max-width:720px;direction:ltr;text-align:left;">
			</p>
			<hr>
			<p>
